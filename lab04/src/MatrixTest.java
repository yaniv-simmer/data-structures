...
public class MatrixTest {
	...
	private Matrix<Integer> my_matrix;
	...
	public void setUp() throws Exception {
		...
		my_matrix = matrixFactory.getMatrix(10, defaultVal);   //mine
	...
	public void testSparseMatrixSize() {
		...
		//mine
		my_matrix.set(1,2,newInstance3);
		assertEquals(3,3,defaultVal);
		assertEquals(1,2,newInstance3);
	}
	...
	public void testGetSet() {
		...
		//mine
		my_matrix.set(10,10,newInstance3);
		assertEquals(my_matrix.get(10,10),newInstance3);
		my_matrix.set(10,10,defaultVal);
		assertEquals(my_matrix.get(10,10),defaultVal);
		my_matrix.set(10,10, newInstance2);
		assertEquals(my_matrix.get(10,10),newInstance2);
	...
	public void testTranspose() {
		...
		assertEquals(my_matrix.get(10,10),newInstance2);
		my_matrix.transpose();
		my_matrix.set(3,7,newInstance2);
		assertEquals(newInstance2,my_matrix.get(3,7) );
		my_matrix.transpose();
		assertEquals(newInstance2,my_matrix.get(7,3) );
		assertEquals(defaultVal,my_matrix.get(3,7) );
